...
#### (3)\_struct\_inode\_和\_struct\_file
...
#### (5)\_调用链路(以\_echo\_1\_>\_/dev/led\_为例)
...
##### 1)\_class\_create\_与\_sysfs

- 如何让设备出现在 `/sys/class`
- 用户空间 udev 如何自动创建设备节点

##### 2)\_device\_tree\_与\_platform\_driver
