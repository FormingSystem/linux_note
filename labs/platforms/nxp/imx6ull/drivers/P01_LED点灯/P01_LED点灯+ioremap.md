...
#### (5)_调用链路(以_echo_1_>_/dev/led_为例)
...
##### 1)_class_create_与_sysfs

- 如何让设备出现在 `/sys/class`
- 用户空间 udev 如何自动创建设备节点

##### 2)_device_tree_与_platform_driver
