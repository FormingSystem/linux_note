...
### 7.3.3 删除黑色节点，以及异常场景处理方法

#### 1. 删除黑节点后，真正要看的是兄弟能不能“借”
...
##### 4.5 第一步：对兄弟 40 做右旋，把近侄子红转换成远侄子红
...
##### 4.9 为什么红黑树要分两步，而 2-3-4 树看起来一步完成
...
##### 5.2 对应到 2-3-4 树：P 和 S 属于同一个逻辑节点
...
##### 5.3 删除 10(B) 后：左侧 child 0 发生 underflow
...
##### 6.3 情况二：S 是黑色，SL 和 SR 都是黑色 —— 兄弟不能借
...
##### 6.4 情况三：S 是黑色，SR 是红色 —— 远侄子红，可以直接借
...
##### 6.5 情况四：S 是黑色，SL 是红色，SR 是黑色 —— 近侄子红，需要先转换
