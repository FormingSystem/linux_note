...
## 14.5 旧模型：rbtree + linked list + vmacache

### 	14.5.1 用复杂示例看旧模型的三套结构
...
### 14.5.2 复杂操作一：`mprotect` 跨两个 VMA 时旧模型要维护什么
...
### 14.5.3 复杂操作二：`munmap` 造成前后残片和中间空洞
...
### 14.6.1 用复杂示例看 Maple Tree 的范围视角
...
### 14.6.3 gap search 为什么是 VMA 管理的核心需求
...
## 14.8 Maple Tree 的普通 API 与高级 API
...
### 14.8.1 `rbtree` 使用方式和 Maple Tree 普通 API 的差异
...
### 14.9.1 复杂并发场景：page fault 读路径与 munmap 写路径
...
### 14.11.1 page fault 路径中的 Maple Tree 位置
...
## 14.12 不能把 Maple Tree 扩大成“所有 rbtree 都被替代”
