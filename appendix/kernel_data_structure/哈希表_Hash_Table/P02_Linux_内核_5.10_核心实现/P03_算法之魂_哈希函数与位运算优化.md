...
`DEFINE_HASHTABLE()` 定义位于 [include/linux/hashtable.h](../../../kernel_source/include/linux/hashtable.h):
...
* [**`struct hlist_head`（哈希桶头）定义说明**](./P02_内核基石_hlist非对称链表.md# 内核源码结构定义：)，定义位于 [include/linux/types.h](../../../kernel_source/include/linux/types.h);

* `HLIST_HEAD_INIT` 定义位于 [include/linux/list.h](../../../kernel_source/include/linux/list.h)：
...
`hash_32()` 定义位于 [include/linux/hash.h](../../../kernel_source/include/linux/hash.h):
...
你在源码中看到的 `hash_64_generic` 实现，展示了内核处理跨架构兼容性的顶级智慧，定义位于 [include/linux/hash.h](../../../kernel_source/include/linux/hash.h)：
...
`hash_ptr()` 定义位于 [include/linux/hash.h](../../../kernel_source/include/linux/hash.h)：
...
`hash_long()` 定义位于 [include/linux/hash.h](../../../kernel_source/include/linux/hash.h)：
...
`hash32_ptr()` 定义位于 [include/linux/hash.h](../../../kernel_source/include/linux/hash.h)：
