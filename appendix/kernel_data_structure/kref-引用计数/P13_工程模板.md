...
## 13.3 基础对象模板：alloc、init、get、put、release

### 13.3.1 模板一：最小 kref 对象模板
...
### 13.3.2 模板二：alloc/init/get/put/release 分层模板
...
## 13.4 lookup 集合模板：list、hash、xarray

### 13.4.1 模板三：list + mutex + kref lookup 模板
...
### 13.4.2 模板四：hash/list + spinlock + kref lookup 模板
...
### 13.4.3 模板五：xarray + kref lookup 模板
...
## 13.5 handoff 异步模板：work、timer、completion、错误回滚

### 13.5.1 模板六：workqueue handoff 模板
...
#### 13.5.1.1 模型 A：每次成功投递 work，work 持有一份引用
...
#### 13.5.1.2 模型 B：调用者当前引用 handoff 给 work
...
### 13.5.3 模板八：completion / wait 用户持有模板
...
## 13.6 删除和弱引用模板：remove、RCU、缓存指针

### 13.6.1 模板十：remove / unlink / drain / release 模板
...
### 13.6.2 模板十一：RCU lookup + kref_get_unless_zero + kfree_rcu
...
## 13.7 分层持有模板：父子对象、file、包装函数、状态机

### 13.7.1 模板十三：父子对象引用模板
...
### 13.7.2 模板十四：file->private_data 持有引用
...
## 13.8 约定和收尾模板：注释、borrow、release、退出、断言

### 13.8.1 模板十七：引用归属注释模板
