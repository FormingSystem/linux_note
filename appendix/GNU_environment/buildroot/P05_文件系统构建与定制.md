...
- 可以通过 Buildroot 的 `menuconfig` → **Target packages → BusyBox** 来配置。
  ...
  ![image](../../../images/buildroot/BusyBox_Target_packages.png)

  ![image](../../../images/buildroot/Busybox_configuration.png)
...
## 1. Overlay 机制（BR2_ROOTFS_OVERLAY）
