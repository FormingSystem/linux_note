...
# 第4章\_Linux\_6.12\_Lockdep查询注解与配置源码实现
...
## 4.2\_lock\_is\_held\_type当前持锁查询
...
## 4.5\_PROVE\_LOCKING\_DEBUG\_LOCK\_ALLOC与LOCKDEP
...
## 4.6\_lockdep\_proc\_init与proc接口
