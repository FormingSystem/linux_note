...
[P13工程模板](../../../../knowledge/linux/object_lifetime/kref/P19_XArray身份与删除工程模板.md#19.1_整数索引与期待对象删除)复用完整note_kref_xarray，补充编号复用后的调用意图。按ID删除取回该编号当前条目；若调用者持旧A、编号已映射到B，就不能把这种接口当作只撤下A。
