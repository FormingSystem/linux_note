...
[读取快照](../source_explanations/include/linux/kref.h.md#1.5_读取快照不新增责任)只用于已有保活窗口里的观察，不是判断下次 get 安全的同步。具体 helper 的旧值、oldp 及返回分支见[原语实现](../source_explanations/include/linux/refcount.h.md#1.2_普通增加与异常检测)。
