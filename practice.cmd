...
set "PRACTICE_DIR=%~dp0tools\practice_tool"
...
if not exist "%PRACTICE_DIR%\package.json" (
    echo [practice] Cannot find tools\practice_tool\package.json
    pause
    exit /b 1
)
...
if %errorlevel% equ 0 (
    ...
    if exist "%ProgramFiles%\nodejs\npm.cmd" (
        ...
        echo [practice] Close this window and double-click practice.cmd again.
        pause
        exit /b 1
    )
)
