...
- 地图已经展开所有正式专题的真实 `PXX` 章节；当前 🟢 **kref** 和 🟢 **红黑树** 各 15 章、🟢 **GNU C 扩展**、🟢 **U-Boot** 的 2 篇个人实验材料，以及地图 1.6、1.7、1.9 下已确认的工程方法、平台实现、14 篇个人实验、参考与出版物材料均保持原状态；🟡 **Lockdep** 的 P01～P09 已完成人工通读和批注，重构后仍处于待复核的人工评审中，新增加的 Lockdep 实验从 🔴 **未校正** 开始，其余地图节点保持 🔴 默认状态。
