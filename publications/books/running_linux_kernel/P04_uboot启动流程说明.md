...
## 4.2\_第二部分\_SPL/TPL\_阶段\_分岔\_承接与过渡
...
### 4.2.3\_统一时间线(从\_BootROM\_到下一阶段)
...
### 4.2.4\_TPL\_to\_SPL\_为什么需要\_三级
...
#### (2)\_形态二\_Falcon\_mode(SPL\_直接跳内核)
...
#### (3)\_形态三\_无\_SPL(BootROM\_直启\_proper)
...
### 4.2.6\_SPL\_to\_U-Boot\_proper\_接力细节
...
### 4.2.7\_SPL\_to\_Linux(Falcon)\_另一条\_快车道
...
### 4.2.8\_多视角对照表(TPL/SPL/Proper/Falcon)
...
## 4.3\_第三部分\_U-Boot\_proper\_阶段\_舞台中央的登场
...
### 4.3.1\_CPU\_的视角\_第一次在\_DDR\_上取指
...
#### (2)\_board\_init\_f(common/board\_f.c)
...
#### (4)\_relocate\_code(arch/arm/lib/relocate\_64.S)
...
#### (6)\_board\_init\_r(common/board\_r.c)
...
### 4.3.5\_过渡的视角(U-Boot\_proper\_to\_内核)
...
### 4.3.7\_总览图(U-Boot\_proper\_内部流程)
...
## 4.4\_第四部分\_CPU\_地址空间与内存管理

### 4.4.1\_CPU\_的世界观\_统一的\_总线地址
...
### 4.4.4\_U-Boot\_proper\_阶段\_搬家与地址空间规划
...
### 4.4.5\_Linux\_Kernel\_阶段\_MMU\_与虚拟内存的登场
...
## 4.5\_第五部分\_Relocation\_机制\_U-Boot\_的搬家艺术
...
## 4.7\_第七部分\_内存管理延伸\_突破\_4GB\_的围墙

### 4.7.1\_问题的起点\_32\_位\_CPU\_的\_4GB\_天花板
...
### 4.7.3\_LPAE\_让\_32\_位\_CPU\_看见大内存
...
### 4.7.6\_时间线对照\_从\_BootROM\_到用户空间
