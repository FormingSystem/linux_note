...
# 第2章\_struct\_class\_数据结构解析(基于\_Linux\_6.1)
...
## 3.4\_device\_destroy()\_与\_class\_destroy()
...
## 5.1\_devnode\_回调\_自定义\_/dev\_节点
...
## 5.4\_与\_miscdevice\_的对比

### 5.4.1\_class\_+\_cdev\_模式

- 优点：完全可控（主/次设备号、权限、sysfs 属性、自定义扩展）。
- 缺点：代码稍繁琐，需要手动管理 cdev 和 class。

### 5.4.2\_miscdevice\_模式
...
## 6.6\_mknod\_与\_class\_create\_的内核机制对比

------

### 6.6.1\_为什么\_mknod\_不需要\_class
...
### 6.6.2\_为什么\_class\_create\_必须存在于自动节点创建
...
### 6.6.3\_mknod\_会不会自动创建\_demo\_class
...
### 6.6.4\_对比图\_mknod\_vs\_class\_create
...
## 7.3\_与\_miscdevice\_的取舍

### 7.3.1\_使用\_class\_+\_cdev

- 适合复杂驱动、多设备实例。
- 节点名、权限、sysfs 属性均可定制。
- 工业级、生产驱动的首选方案。

### 7.3.2\_使用\_miscdevice
...
## 8.7\_一个硬件设备呈现多个\_class\_视图\_是否可行\_原理何在
...
### 8.7.2\_为什么不能把同一个\_struct\_device\_挂到多个\_class
...
### 8.7.3\_正确的工程做法\_多\_class\_设备\_并列呈现
...
### 8.7.5\_多\_class\_视图下的命名\_权限\_生命周期建议
...
### 8.7.6\_结构图\_同一硬件\_多\_class\_设备并列
...
# 第9章\_/demo\_驱动中的\_/sys/\_与\_/dev/\_区别
...
## 9.9\_sysfs\_属性与\_/dev\_节点的交互关系
...
# 第10章\_class\_与\_device\_的源码实现原理
...
## 10.2\_class\_create()\_的实现

### 10.2.1\_内核函数入口(kernel\_6.1)
...
# 第11章\_class\_与\_device\_的内核对象模型
...
### 12.6.2\_Linux\_2.6\_初期\_uevent\_+\_udev
...
### 12.6.3\_Linux\_2.6.32+\_devtmpfs\_引入
...
### 12.6.4\_Linux\_4.x\_~\_6.x\_现代模式
...
# 第13章\_驱动开发中的\_class\_与\_device\_使用实践
...
## 16.3\_sysfs\_属性不生效的常见原因

### 16.3.1\_show/store\_未定义
...
### 16.5.3\_验证\_sysfs\_与\_/dev\_的一致性
...
## 17.3\_devtmpfs\_+\_udev\_模式(桌面系统)
...
## 18.6\_sysfs\_权限与安全性讨论

### 18.6.1\_为什么\_sysfs\_严格限制写操作
...
### 19.3.3\_debugfs\_与\_sysfs\_的关系
...
## 20.2\_设备树与\_sysfs\_的交集

### 20.2.1\_设备树如何影响\_sysfs
...
## 27.3\_device\_add\_与\_sysfs\_节点创建
...
## 27.4\_device\_del\_与\_sysfs\_节点销毁
...
# 第28章\_devtmpfs\_深入与\_/sys\_的互补性
...
## 29.3\_cgroups\_与\_sysfs/kernfs\_的关系
...
## 29.6\_sysfs\_设备节点\_vs\_cgroups\_节点
...
## 29.9\_可视化\_sysfs\_与\_cgroups\_的层次
...
## 32.4\_/sys/fs/cgroup\_与\_cgroup\_命名空间
...
# 第37章\_附录(Sysfs/Class\_速查手册\_Linux\_6.1)
...
## 37.2\_A.\_设备模型与\_class\_接口

### 37.2.1\_A.1\_struct\_class
...
### 37.2.2\_A.2\_class\_create\_/\_class\_destroy
...
### 37.2.3\_A.3\_device\_create\_/\_device\_destroy
...
## 37.3\_B.\_sysfs\_属性接口

### 37.3.1\_B.1\_struct\_device\_attribute
...
### 37.3.4\_B.4\_sysfs\_emit\_/\_sysfs\_emit\_at
...
### 37.4.3\_C.3\_struct\_cdev\_与注册
...
### 37.4.4\_C.4\_struct\_file\_operations
...
## 37.5\_D.\_uaccess\_锁与工具函数

### 37.5.1\_D.1\_用户态拷贝函数
...
## 37.6\_E.\_uevent\_与\_kobject

### 37.6.1\_E.1\_struct\_kobject
...
## 37.7\_F.\_devtmpfs\_与\_/dev

### 37.7.1\_F.1\_devtmpfs\_概述
...
### 37.7.2\_F.2\_与\_device\_create\_的关系
...
### 37.8.1\_G.1\_Runtime\_PM(运行时电源管理)
...
### 37.8.2\_G.2\_系统级\_Suspend/Resume
...
## 37.10\_H.\_内核模块与初始化接口

### 37.10.1\_H.1\_模块入口与出口
...
### 37.10.4\_H.4\_初始化函数常见步骤(字符设备驱动)
