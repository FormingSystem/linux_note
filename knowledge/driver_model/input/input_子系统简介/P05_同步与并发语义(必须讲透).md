...
## 5.1\_概念总览\_Input\_驱动的四个关键上下文

### 5.1.1\_是什么\_四种典型执行上下文
...
### 5.2.3\_怎么实现\_典型模式对照(坏写法\_vs\_好写法)

#### (1)\_坏写法\_硬中断里\_I²C\_+\_上报
...
### 5.2.4\_workqueue\_/\_轮询场景下的\_采集可睡\_上报不睡
...
### 5.2.6\_调试与验证\_如何确认自己没有踩\_睡眠\_红线
...
## 5.3\_设备级顺序\_input\_core\_的内部并发语义
...
### 5.3.1\_是什么\_从\_input\_report\_*()\_到用户态的\_设备级总顺序
...
### 5.3.3\_开发者视角\_你需要保证哪些顺序\_哪些不用管
...
### 5.3.4\_可视化\_设备级顺序与多读者(多个\_FD)的关系
...
### 5.3.7\_小结\_把\_设备级顺序\_交给结构\_而不是记忆
...
## 5.4\_帧一致性与\_TOCTOU\_data-ready\_检查\_+\_有限重读
...
### 5.4.1\_是什么\_帧一致性与\_TOCTOU\_在\_Input\_驱动中的含义

#### (1)\_帧一致性(frame\_consistency)
...
### 5.4.3\_怎么实现(1)\_帧号模式(frame\_id\_前后一致)
...
### 5.4.4\_怎么实现(2)\_data-ready\_+\_有限重读模式
...
### 5.4.6\_对比\_/\_避坑\_/\_限制

#### (1)\_反模式\_1\_完全相信第一次\_status
...
#### (3)\_反模式\_3\_在两个上下文中交替读写同一\_FIFO
...
### 5.4.7\_示例代码\_I²C\_触摸屏的\_data-ready\_+\_有限重读
...
## 5.5\_关机\_/\_休眠顺序\_disable\_irq\_sync()\_与电源状态切换
...
### 5.5.1\_引入\_为什么\_关机/休眠顺序\_是\_Input\_驱动的高危区
...
### 5.5.2\_数据结构视角\_device\_/\_input\_dev\_/\_IRQ\_/\_wakeup\_的关系
...
### 5.5.4\_用户\_/\_平台视角\_系统关机\_/\_休眠中的\_Input\_驱动角色
...
### 5.5.6\_示例代码\_suspend/resume/shutdown\_模板(含\_devres/非\_devres\_对比)
...
#### (2)\_suspend\_/\_resume(非\_devres/普通风格)
...
#### (3)\_devres\_风格\_devm\_request\_threaded\_irq()\_与\_PM\_的关系
...
### 5.5.8\_小结\_把\_disable\_irq\_sync()\_固定在模板里的位置
...
## 5.6\_背压与丢帧\_EV\_SYN/SYN\_DROPPED\_与用户态自愈重同步
...
### 5.6.1\_是什么\_Input\_里的\_背压\_和\_丢帧提示
...
#### (2)\_丢帧(drop)与\_EV\_SYN\_/\_SYN\_DROPPED
...
### 5.6.2\_干什么\_为何要显式支持\_丢帧提示\_+\_自愈重同步
...
### 5.6.3\_怎么实现(1)\_内核\_/\_驱动侧的责任与\_不做的事
...
### 5.6.4\_怎么实现(2)\_用户态的\_自愈重同步\_模式
...
### 5.6.5\_用户态代码模板\_处理\_SYN\_DROPPED\_的最小循环
...
#### (3)\_主循环\_检测\_SYN\_DROPPED\_并调用重同步
...
### 5.6.6\_对比\_/\_避坑\_错误处理方式与后果

#### (1)\_反模式\_1\_完全忽略\_SYN\_DROPPED
...
#### (2)\_反模式\_2\_看到\_SYN\_DROPPED\_后立即退出程序
...
### 5.6.8\_小结\_把\_丢帧\_当作协议的一部分\_而不是异常
