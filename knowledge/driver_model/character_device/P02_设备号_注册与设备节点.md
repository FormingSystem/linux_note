---
id: knowledge.driver_model.character_device.p01_设备号框架简介.p01_设备号与设备节点_从_0_到多实例
title: "设备号、注册与设备节点"
kind: subsystem
status: evolving
domains:
...
## 2.2\_手工节点\_vs\_自动节点\_两条路线

### 2.2.1\_路线\_A\_手工节点(mknod)
...
### 2.2.2\_路线\_B\_自动节点(class\_+\_device)
