...
### 2.1.1\_主题引入\_设备树如何解决LED驱动的硬件依赖问题
...
### 2.1.2\_数据结构视角\_设备树与GPIO驱动的核心载体
...
### 2.2.1\_主题引入\_为什么需要标准化的GPIO设备树语法
...
### 2.2.2\_GPIO控制器节点语法\_内核识别GPIO硬件的基础
...
### 2.2.3\_GPIO设备节点核心语法\_gpios属性(输出场景示例)
...
### 2.3.1\_led\_set\_state()只能控制单个GPIO的原因分析
