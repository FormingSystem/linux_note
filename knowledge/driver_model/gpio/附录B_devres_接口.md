...
# 第3章\_devm\_gpiod\_get\_from\_of\_node()
...
### 3.7.1\_从子节点读取\_GPIO(MFD/复合设备常见)
...
### 3.7.2\_同一属性多路\_GPIO(用\_index\_选择)
...
# 第4章\_devm\_gpiod\_get\_optional()
...
# 第5章\_devm\_gpiod\_get\_index\_optional()
...
## 5.5\_5\_flags\_参数取值(GPIO\_初始化行为)
