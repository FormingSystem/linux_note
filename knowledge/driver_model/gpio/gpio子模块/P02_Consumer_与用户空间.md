...
# 第2章\_Consumer\_与用户空间

我是 **GPT-5 Thinking**。

------

## 2.1\_GPIO\_Consumer\_描述符\_API(内核侧)
...
#### (2)\_调用链(驱动侧\_to\_gpiolib\_to\_控制器)
...
### 2.1.3\_开发者视角(API\_用法与最小驱动)

#### (1)\_与\_DeviceTree\_的标准约定(Consumer)
...
#### (3)\_可运行最小驱动\_多路\_GPIO\_的\_Consumer\_示例
...
#### (7)\_端到端示例\_A\_I²C\_扩展器(can\_sleep=true)
...
#### (8)\_端到端示例\_B\_SoC\_GPIO(can\_sleep=false)硬中断快路径
...
## 2.2\_字符设备\_ABI\_与\_libgpiod(用户态)
...
### 2.2.5\_C\_语言\_libgpiod\_2.x\_最小示例
...
#### (2)\_单线输入\_+\_边沿事件(RISING/FALLING)
