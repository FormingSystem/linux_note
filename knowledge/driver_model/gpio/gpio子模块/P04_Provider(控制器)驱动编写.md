...
#### (2)_消费者节点(consumer)与_<name>-gpios
...
#### (6)_模式_F_gpio-line-names(统一命名与测试)
...
## 4.2_GPIO_扩展器与桥接器(I²C_/_SPI_/_PMIC)
...
### 4.2.3_设备树绑定(Provider_与_Consumer)
...
#### (3)_I²C_PCF8574(无专用中断_适合轮询或简化输入)
...
### 4.2.4_开发者视角_驱动使用范式(_cansleep_+_threaded_IRQ)
...
### 4.4.3_开发者视角(DTS_+_驱动模板)

#### (1)_设备树_default_/_sleep_两态示例(i.MX6ULL_为例)
...
#### (2)_平台驱动_PM_+_pinctrl_+_IRQ_wake(可编可跑骨架)
...
#### (3)_可选_运行时_PM(autosuspend_节电但不改变系统休眠流程)
...
### 4.4.4_Bootloader_to_内核_引脚接管一致性
