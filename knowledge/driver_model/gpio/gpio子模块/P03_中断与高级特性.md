...
## 3.1\_GPIO\_中断(IRQ)与\_gpio-keys\_/\_自定义驱动
...
### 3.1.3\_开发者视角(一)\_通用驱动\_gpio-keys
...
### 3.1.4\_开发者视角(二)\_自定义\_platform\_驱动\_+\_threaded\_IRQ
...
### 3.2.4\_gpio-keys(按键\_to\_input\_事件)
...
### 3.2.7\_regulator-fixed(GPIO\_使能的稳压器)
...
### 3.2.8\_gpio-mux(用\_GPIO\_选择外部多路器通道)
...
### 3.2.9\_gpio-poweroff\_/\_gpio-restart(GPIO\_控制关机/重启)
