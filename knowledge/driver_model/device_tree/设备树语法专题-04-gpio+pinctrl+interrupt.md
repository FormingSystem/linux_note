...
# 第1章\_GPIO\_+\_pinctrl\_+\_interrupt\_的设备树语法与应用
...
#### (1)\_GPIO\_控制器描述结构\_struct\_gpio\_chip
...
#### (2)\_pinctrl\_控制器描述结构\_struct\_pinctrl\_desc
...
## 1.3\_开发者视角\_设备树\_Provider\_与\_Consumer\_的关系
...
# 第2章\_GPIO\_+\_pinctrl\_+\_interrupt\_的组合应用与高级语法
...
## 2.2\_数据结构视角\_GPIO\_与\_pinctrl\_的内部衔接

### 2.2.1\_pinctrl\_state\_的生命周期
...
## 2.3\_开发者视角\_高级组合语法详解

### 2.3.1\_多状态\_pinctrl\_组合
...
### 2.3.4\_pinctrl\_hog\_自动固定\_pinmux\_状态
...
# 第3章\_Linux\_中断模型深度解析与设备树中的级联机制(第\_3\_部分)
...
## 3.2\_数据结构视角\_从硬件中断号到虚拟\_IRQ

### 3.2.1\_中断域\_irqdomain\_内核中的中断映射核心
...
### 3.2.2\_GIC\_中断模型与\_#interrupt-cells\_=\_3
...
#### (1)\_常见宏定义(来自\_<dt-bindings/interrupt-controller/arm-gic.h>)
...
### 3.2.3\_GPIO\_控制器作为中断控制器\_#interrupt-cells\_=\_2
...
## 3.3\_开发者视角\_中断级联的设备树语法

### 3.3.1\_GPIO\_to\_GIC\_的级联定义
...
### 3.3.3\_使用\_interrupts-extended\_同时声明多个中断源
