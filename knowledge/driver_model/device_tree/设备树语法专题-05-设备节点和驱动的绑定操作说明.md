...
# 第1章\_设备树到设备节点的绑定流程(从\_DTB\_到\_driver\_probe)
...
# 第2章\_设备树\_compatible\_属性与驱动匹配机制详解
...
### 2.2.2\_struct\_platform\_driver
...
### 3.2.2\_内核数据结构\_struct\_alias\_prop
...
## 3.4\_自动编号机制与\_alias\_的缺省行为

### 3.4.1\_of\_alias\_get\_id()\_的行为规则
...
### 3.5.2\_驱动源码\_drivers/demo/alias\_demo.c
...
### 3.6.3\_查看\_/proc/device-tree\_别名
