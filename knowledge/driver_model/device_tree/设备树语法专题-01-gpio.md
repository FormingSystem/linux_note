...
# 第1章\_设备树中的\_GPIO\_语法(Kernel\_6.1+)
...
### 1.3.3\_flags\_常用宏(来自\_<dt-bindings/gpio/gpio.h>)
...
### 1.5.1\_最小可用\_GPIO\_控制器与单\_GPIO\_引用
...
# 第2章\_设备树中的\_GPIO\_中断与\_gpio-keys\_语法(Kernel\_6.1+)
...
### 2.3.1\_interrupt-parent\_与\_interrupts
...
## 2.4\_GPIO\_与中断的关系\_gpio\_to\_irq()
...
## 2.5\_gpio-keys\_子系统语法(标准输入按键定义)
...
### 2.6.2\_结合\_gpio-line-names\_提升可读性
...
# 第3章\_设备树中\_GPIO\_与\_pinctrl\_配合语法详解(Kernel\_6.1+)
...
### 3.2.3\_电气配置宏结构(以\_i.MX6ULL\_为例)
...
## 3.4\_pinctrl\_语法细化与可选属性

### 3.4.1\_pinctrl-names\_与\_pinctrl-0\_…\_pinctrl-N
...
### 3.4.2\_fsl,pins\_/\_rockchip,pins\_属性结构
...
## 3.5\_电气配置属性详解(Pin\_Configuration)

### 3.5.1\_标准属性(Linux\_pinconf\_通用)
...
### 3.6.1\_示例\_定义\_normal/sleep\_两种状态
...
### 3.7.1\_pinctrl\_与\_GPIO\_语法层次关系
