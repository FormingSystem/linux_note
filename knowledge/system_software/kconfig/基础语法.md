---
id: knowledge.system_software.kconfig.基础语法
title: "基本结构与类型定义"
kind: engineering
status: evolving
domains:
...
## 2.3\_menu\_与\_endmenu\_创建逻辑分组菜单
...
## 2.4\_choice\_与\_endchoice\_多选一项配置
...
## 3.1\_source\_引入其他\_Kconfig\_文件
...
## 3.3\_visible\_if\_控制菜单是否可见(而非有效)
...
# 第5章\_.config\_生成机制与\_Kconfig\_编译链

## 5.1\_.config\_是怎么生成的
...
## 5.3\_.config\_to\_生成\_include/generated/autoconf.h
...
## 5.4\_.config\_to\_生成\_include/config/auto.conf\_(config.mk)
...
## 5.6\_Makefile\_中如何使用\_CONFIG\_XXX
...
## 5.7\_小结\_从\_Kconfig\_到编译控制的完整链条
