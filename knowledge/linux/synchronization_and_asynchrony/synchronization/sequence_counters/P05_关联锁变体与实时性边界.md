...
先从[版本总索引](../../../../../research/source_reading/sequence_counters/navigation/P01_Linux_6.12_序列计数器源码总阅读索引.md#1.1_版本边界与阅读任务)进入固定NXP提交。include/linux/seqlock_types.h控制关联字段是否保留，include/linux/seqlock.h生成sequence读取、抢占属性、持锁断言和RT补偿。关系见[模块导读](../../../../../research/source_reading/sequence_counters/navigation/P02_Linux_6.12_seqcount与seqlock模块源码概念导读.md#2.4_关联锁与PREEMPT_RT)，现有[关联属性标题](../../../../../research/source_reading/sequence_counters/source_explanations/P01_Linux_6.12_seqlock_h读写与latch源码实现.md#1.5_关联锁属性与RT补偿)仍标明概念裁剪。本章直接静态核对两份固定头文件，未运行PREEMPT_RT或测量最坏等待时间。
