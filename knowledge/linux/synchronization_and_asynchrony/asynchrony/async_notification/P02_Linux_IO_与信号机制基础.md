...
### 2.1.1\_文件描述符与\_VFS\_基础回顾

#### (1)\_引入\_为什么先讲\_VFS\_和\_fd
...
#### (2)\_数据结构视角\_fd\_/\_struct\_file\_/\_inode\_的最小关系
...
#### (4)\_用户\_/\_平台视角\_fd\_的生命周期与多进程/多\_fd\_情况
...
#### (6)\_示例代码\_最小字符设备骨架(带.fasync\_预留位)
...
### 2.1.2\_阻塞\_I/O\_与非阻塞\_I/O\_的行为差异

#### (1)\_引入\_为什么要先把阻塞\_/\_非阻塞讲清楚
...
#### (2)\_数据结构视角\_file->f\_flags\_中的\_O\_NONBLOCK
...
#### (3)\_开发者视角\_read()\_在阻塞/非阻塞场景下的典型写法
...
##### 2)\_非阻塞\_+\_简单轮询模式(仅用于对比\_不推荐长期使用)
...
#### (8)\_小结\_阻塞\_/\_非阻塞与后续\_fasync\_的关系
...
### 2.1.3\_select/poll/epoll\_的事件等待模型

#### (1)\_引入\_为什么要在\_fasync\_之前先讲\_poll/epoll
...
#### (2)\_数据结构视角\_wait\_queue\_+\_poll\_table\_+\_eventpoll
...
#### (4)\_用户\_/\_平台视角\_select/poll/epoll\_的使用模型
...
#### (5)\_可视化\_poll/epoll\_的事件流与等待队列关系
...
#### (6)\_示例代码\_驱动.poll\_+\_用户态\_poll\_/\_epoll\_示例
...
##### 2)\_用户态\_poll\_示例(与\_2.2\_中不同\_这次侧重事件循环)
...
#### (8)\_小结\_poll/epoll\_在\_fasync\_体系中的基础角色
...
### 2.1.4\_Linux\_信号子系统概要(同步\_vs\_异步\_可重入性\_信号队列)

#### (1)\_引入\_为什么在讲\_fasync\_之前必须理解信号
...
#### (2)\_数据结构视角\_task\_struct\_与信号队列的最小模型
...
#### (5)\_可视化\_从驱动\_kill\_fasync\_到用户\_handler\_的路径
...
#### (6)\_示例代码\_信号\_handler\_与\_signalfd\_的两种用法
...
### 2.1.5\_SIGIO\_/\_SIGPOLL\_与\_I/O\_事件的关系

#### (1)\_引入\_为什么是\_SIGIO\_/\_SIGPOLL\_而不是别的信号
...
#### (2)\_数据结构视角\_sig\_band\_与\_poll\_事件掩码的映射
...
#### (3)\_开发者视角\_驱动如何选择\_sig\_与\_band
...
#### (4)\_用户\_/\_平台视角\_用户态如何利用\_sig\_与\_band\_信息
...
#### (6)\_示例代码\_驱动中合理使用\_SIGIO/SIGPOLL\_与\_band
...
#### (7)\_调试与验证\_如何确认\_band\_与\_poll\_掩码一致
...
#### (8)\_小结\_SIGIO\_/\_SIGPOLL\_与\_I/O\_事件的精确对应
...
下一篇：[P03 fasync 机制的历史与设计动机](P03_fasync_机制的历史与设计动机.md)。
