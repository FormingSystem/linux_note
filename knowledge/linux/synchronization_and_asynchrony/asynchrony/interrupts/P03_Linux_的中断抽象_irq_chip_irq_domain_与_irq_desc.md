...
## 3.3\_irq\_chip\_控制器能力的统一描述

### 3.3.1\_为什么需要\_irq\_chip
...
## 3.4\_irq\_domain\_把硬件号变成\_Linux\_号
...
## 3.5\_irq\_desc\_一条中断线在运行时的完整状态

### 3.5.1\_为什么还需要一层\_irq\_desc
...
### 3.5.2\_驱动注册其实就是\_往\_desc\_里挂\_action
...
上一篇：[P02 SoC 视角下的中断体系](P02_SoC_视角下的中断体系.md)。
下一篇：[P04 Linux 驱动中的中断注册与接口](P04_Linux_驱动中的中断注册与接口.md)。
