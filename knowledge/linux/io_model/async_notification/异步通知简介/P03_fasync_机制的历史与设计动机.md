...
### 3.1.2_Linux_中引入_fasync_的动机(历史层面)
...
### 3.3.2_F_SETOWN_/_F_SETSIG_与_fasync_的耦合
...
### 3.3.3_多个_fd_fork/dup_与_fasync_链表
...
### 3.3.4_close()/release()_与_悬挂_fasync_struct_问题
...
### 3.4.4_fasync_与_select/poll/epoll_的组合使用
