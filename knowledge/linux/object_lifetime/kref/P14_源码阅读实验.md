...
## 14.3_基础生命周期实验_init_get_put_release

### 14.3.1_实验_1_最小_kref_对象
...
## 14.4_引用错误实验_少_get_少_put

### 14.4.1_实验_3_故意少_get_观察异步_UAF_风险
...
## 14.5_lookup_与_handoff_实验_从裸指针转成引用

### 14.5.1_实验_5_list_+_mutex_+_lookup_+_kref_get
...
### 14.5.2_实验_6_lookup_改成_kref_get_unless_zero
...
#### (2)_用_mutex_保护的_get_unless_zero_示例
...
### 14.5.3_实验_7_workqueue_handoff_成功/失败路径
...
## 14.6_RCU_与调试工具实验_KASAN_KCSAN_lockdep

### 14.6.1_实验_8_RCU_lookup_+_kfree_rcu
...
## 14.7_API_误用和_remove_实验_多_put_kref_read_未脱链

### 14.7.1_实验_12_refcount_warning_观察多_put
...
### 14.7.2_实验_13_kref_read_不能判断对象有效
...
## 14.8_状态和父子关系实验_生命周期不等于业务可用

### 14.8.1_实验_15_remove_后旧用户仍持有引用
