...
固定证据先进入[等待与完成量总索引](../../../../research/source_reading/waiting_notification/navigation/P01_Linux_6.12_等待与完成量源码总阅读索引.md#1.5_建议阅读顺序)，再读[完成量状态所有权](../../../../research/source_reading/waiting_notification/navigation/P03_Linux_6.12_completion模块源码概念导读.md#3.2_状态所有权)。具体状态见[对象与初始化](../../../../research/source_reading/waiting_notification/source_explanations/include/linux/completion.h.md#1.2_completion对象与初始化)、[等待消费](../../../../research/source_reading/waiting_notification/source_explanations/kernel/sched/completion.c.md#1.4_do_wait_for_common等待与消费)和[广播完成](../../../../research/source_reading/waiting_notification/source_explanations/kernel/sched/completion.c.md#1.5_complete_all发布永久完成)。这些接口操作完成量，不知道request.ref由谁拥有。
...
下一篇：[分阶段失败与资源回滚](P23_分阶段失败与资源回滚模板.md#23.1_先列出失败时已经成立的责任)。
