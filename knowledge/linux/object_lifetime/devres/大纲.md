...
| [内核与用户态设备管理讨论](devres_旧机制_udev_mdev的讨论.md) | 已区分资源账本与设备外壳 | 从两层职责进入[退出时序](devres_旧机制_udev_mdev的讨论.md#2.3_时序与控制流)，用[七条C轨迹](devres_旧机制_udev_mdev的讨论.md#2.5_代码框架%28最小充分示例%29)区分最终清理与中途失效窗口，再进入用户态事件和策略 |
