...
# 第6章\_SRCU\_私有域与双\_index\_运行机制

## 6.1\_SRCU\_不只是“可睡眠的\_RCU”
...
上一篇：[Tree RCU 宽限期与回调机制](P05_Tree_RCU_宽限期与回调机制.md)。

下一篇：[RCU API 速查](P07_RCU_API_速查.md)。
