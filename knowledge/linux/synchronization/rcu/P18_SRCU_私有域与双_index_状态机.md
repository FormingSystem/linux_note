...
## 18.6\_synchronize\_srcu()为什么会阻塞
...
上一篇：[RCU 种类与内核配置](P17_RCU_实现家族与内核配置.md)。

下一篇：[Tasks RCU 与 Tiny RCU 实现边界](P19_Tasks_RCU与Tiny_RCU实现边界.md)。
