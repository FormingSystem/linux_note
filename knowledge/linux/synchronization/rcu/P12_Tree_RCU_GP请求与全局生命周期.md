...
| 字段、序列辅助函数、创建、请求、唤醒与主循环 | [Linux 6.12 Tree RCU GP 全局生命周期源码实现](../../../../research/source_reading/rcu/source_explanations/P05_Linux_6.12_Tree_RCU_GP全局生命周期源码实现.md#5.2_源码符号覆盖账本) |
