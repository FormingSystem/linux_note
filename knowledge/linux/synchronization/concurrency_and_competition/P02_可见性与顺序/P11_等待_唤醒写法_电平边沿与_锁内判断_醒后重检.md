---
id: knowledge.linux.synchronization.concurrency_and_competition.p02_可见性与顺序.p11_等待_唤醒写法_电平边沿与_锁内判断_醒后重检
title: "等待 唤醒写法 电平边沿与 锁内判断 醒后重检"
kind: mechanism
status: evolving
domains:
  - linux
...
# 第11章\_等待\_唤醒写法\_电平边沿与\_锁内判断\_醒后重检

## 11.1\_等待\_唤醒写法\_电平/边沿与\_锁内判断\_醒后重检
