...
## 23.1\_工作队列(Workqueue)

------

### 23.1.1\_概念与设计动机

#### (1)\_从\_中断延后\_到\_进程上下文
...
| 底半部（软中断） | SoftIRQ/Tasklet | ❌      | 网络包接收、默认 RCU core/回调路径 | 延后不可睡逻辑；RCU nocb 配置可把部分回调工作交给专用线程 |
...
#### (2)\_内核视角\_kworker\_与\_work\_struct
...
#### (2)\_延迟工作\_struct\_delayed\_work
...
#### (3)\_队列结构\_struct\_workqueue\_struct
...
### 23.1.4\_复杂的工作环境\_多队列\_延迟与嵌套执行

------

#### (1)\_per-CPU\_与\_unbound\_的对比
...
#### (5)\_执行上下文对比(与\_SoftIRQ\_/\_Completion)
