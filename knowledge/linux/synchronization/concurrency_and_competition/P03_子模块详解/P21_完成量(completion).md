...
# 第21章\_完成量(completion)

## 21.1\_完成量(completion)
...
### 21.1.3\_语义分析\_一次性同步的\_握手点

#### (1)\_completion\_解决了什么问题
...
###### b)\_数据结构层面\_确实是\_waitqueue\_的封装
...
### 21.1.6\_开发者视角\_completion\_与\_waitqueue\_的关系
...
##### 1)\_内部逻辑(以\_wait\_for\_completion()\_为例)
...
##### 1)\_内核源码(摘自\_kernel/sched/completion.c)
...
## 21.2\_附页\_completion\_vs\_semaphore(信号量)语义对比与误用分析
