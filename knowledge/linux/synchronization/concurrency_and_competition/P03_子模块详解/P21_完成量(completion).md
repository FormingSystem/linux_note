...
### 21.1.3_语义分析_一次性同步的_握手点

#### (1)_completion_解决了什么问题
...
### 21.1.6_开发者视角_completion_与_waitqueue_的关系
...
##### 1)_内部逻辑(以_wait_for_completion()_为例)
...
##### 1)_内核源码(摘自_kernel/sched/completion.c)
...
## 21.2_附页_completion_vs_semaphore(信号量)语义对比与误用分析
