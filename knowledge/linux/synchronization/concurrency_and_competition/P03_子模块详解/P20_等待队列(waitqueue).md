...
## 20.3\_数据结构视角\_waitqueue\_head\_与\_wait\_queue\_entry
...
### 20.3.2\_struct\_wait\_queue\_head
...
### 20.3.3\_struct\_wait\_queue\_entry
...
## 20.4\_核心接口族\_wait\_event\_/\_wake\_up\_/\_prepare\_to\_wait\_详解
...
### 20.4.4\_prepare\_to\_wait\_与\_finish\_wait
...
## 20.6\_等待队列的三视角分析\_生产者\_消费者与全局协作

------

### 20.6.1\_设计动机\_为什么\_waitqueue\_模型是\_合理\_的
...
### 20.6.2\_生产者视角\_负责\_修改状态\_+\_唤醒队列
...
### 20.6.3\_消费者视角\_负责\_注册等待\_+\_重检条件
...
#### (2)\_wake\_up()\_vs\_wake\_up\_one()\_对比
...
## 20.8\_低层等待接口族\_prepare\_to\_wait*()\_与\_finish\_wait()
...
### 20.8.3\_典型使用模式(等价于\_wait\_event\_循环)
...
## 20.9\_任务状态语义\_TASK\_INTERRUPTIBLE\_/\_UNINTERRUPTIBLE\_/\_KILLABLE\_等待模式
...
### 20.9.7\_调度状态与\_finish\_wait()\_协同
...
## 20.10\_等待队列与\_schedule\_timeout\_超时等待机制详解
...
### 20.10.3\_schedule\_timeout()\_工作机制
...
### 20.10.4\_wait\_event\_*\_timeout()\_内部流程
...
### 20.10.7\_与\_finish\_wait()\_任务状态的关系
...
## 20.11\_等待队列\_超时与信号交互\_interruptible\_与\_killable\_的实战差异

------

### 20.11.1\_概念\_信号与等待的交汇点
...
### 20.11.3\_TASK\_INTERRUPTIBLE\_与\_TASK\_KILLABLE\_的本质差别
...
#### (3)\_示例\_3\_系统挂载或卸载任务(killable\_等待)
...
## 20.12\_completion\_机制\_单事件同步的最小原语

------

### 20.12.1\_概念\_等待队列的\_单事件封装
...
### 20.12.9\_completion\_与\_wait\_queue\_的差异
...
## 20.13\_complete()\_与唤醒机制\_任务唤醒数量与状态传播原理
...
### 20.13.3\_核心语义\_唤醒数量由\_nr\_exclusive\_参数控制
...
### 20.13.4\_wake\_up\_common\_lock()\_的行为机制
...
## 20.14\_completion\_与\_waitqueue\_的混搭\_多阶段同步模型
...
## 20.15\_complete()\_to\_try\_to\_wake\_up()\_唤醒路径与调度切换详解
...
## 20.16\_completion\_的\_done\_计数机制与唤醒行为解耦原理
...
### 20.16.3\_生产者行为\_complete()\_与\_complete\_all()
...
### 20.16.4\_消费者行为\_wait\_for\_completion()
...
### 20.16.6\_reinit\_completion()\_状态复位机制
...
### 20.16.7\_complete\_all()\_与\_done\_饱和行为
...
## 20.17\_complete\_all()\_的广播模型与使用边界
...
## 20.18\_wait\_for\_completion\_interruptible()\_与信号响应机制
...
### 20.18.6\_与\_wait\_event\_interruptible()\_的对比
...
## 20.19\_completion\_同步模型在\_probe/remove\_中的设计模式
...
### 20.19.3\_设计模式一\_probe\_等待异步初始化完成
...
### 20.19.4\_设计模式二\_remove\_等待后台线程退出
...
### 20.20.5\_trace-cmd\_与\_KernelShark\_可视化同步路径
...
### 20.20.6\_/proc/sched\_debug\_与锁统计接口
...
### 20.20.7\_验证\_checklist\_同步路径自检要点
...
#### (1)\_错误\_在中断上下文使用\_wait\_for\_completion()
