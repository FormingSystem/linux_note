...
# 第22章_中断_软中断_线程化中断_工作队列(执行路径)

## 22.1_中断_/_软中断_/_线程化中断_/_工作队列(执行路径)
...
#### (8)_驱动示例(可编译版)_Top_Half_调度_SoftIRQ(tasklet)
...
#### (5)_Top_Half_+_Threaded_Bottom_Half_混合模式
