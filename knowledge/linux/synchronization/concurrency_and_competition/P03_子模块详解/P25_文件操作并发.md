...
## 25.1\_文件操作并发(open/close/read/write/poll/mmap/ioctl)
...
### 25.1.2\_机制引入\_从系统调用到\_file\_operations
...
### 25.1.6\_典型模板\_带\_mutex\_的\_read/write\_同步
...
#### (3)\_机制回答二\_struct\_file\_的独立性如何保留
...
### 25.1.7\_poll\_与\_waitqueue\_同步

------

#### (1)\_问题引入\_为什么需要\_poll
...
#### (2)\_语义模型\_poll\_=\_注册\_+\_检查\_+\_唤醒
...
##### 2)\_B.\_vm\_operations\_struct\_生命周期
...
##### 1)\_A.\_一致性\_DMA\_缓冲\_+\_mmap\_+\_ioctl(推荐模板)
...
### 25.1.9\_release\_阶段与\_devres\_资源释放
