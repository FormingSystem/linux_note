...
## 17.11_mutex_lock()_与_mutex_lock_interruptible()_的区别与使用边界
...
### 17.11.4_为何_可中断等待_会破坏资源稳定性

#### (1)_问题并非_修改资源_而是_提前返回
...
## 17.12_semaphore_接口与使用规则(计数型可睡锁)
...
## 17.13_rw_semaphore_接口与使用规则(读写信号量)
...
## 17.14_downgrade_write()_写锁降级为读锁的机制与使用场景
