...
# 第24章\_timer\_hrtimer(时间回调与同步取消)

## 24.1\_timer\_/\_hrtimer(时间回调与同步取消)
...
### 24.1.4\_开发者视角\_API\_分类与上下文限制

#### (1)\_低精度定时器\_API\_一览(timer\_list)
...
#### (1)\_del\_timer\_与\_del\_timer\_sync\_语义
...
#### (1)\_总结性表格\_timer\_/\_hrtimer\_比较
