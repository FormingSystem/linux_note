...
### 24.1.4_开发者视角_API_分类与上下文限制

#### (1)_低精度定时器_API_一览(timer_list)
...
#### (1)_del_timer_与_del_timer_sync_语义
