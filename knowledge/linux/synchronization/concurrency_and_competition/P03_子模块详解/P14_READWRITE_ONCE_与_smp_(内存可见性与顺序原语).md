...
#### (4)_为何会引入_READ_ONCE()/WRITE_ONCE()_机制
...
##### 3)_READ_ONCE_/_WRITE_ONCE_的设计动机
...
##### 2)_READ/WRITE_ONCE_解决的是_可见性_不是_顺序性
...
##### 5)_举例_为什么不能靠_READ_ONCE_/_WRITE_ONCE_解决
...
##### 6)_Linux_为什么用_smp_*()_而不是直接用_CPU_指令
...
### 14.1.9_内存屏障的可视化与验证(Store_Buffer_/_Load_Queue_执行模型)
