...
## 16.11_自旋锁在多核缓存一致性(MESI)下的传播机制与延迟分析

------

### 16.11.1_背景_为何要分析缓存一致性
...
### 16.11.7_Linux_的优化机制_Queued_Spinlock_(qspinlock)
...
#### (2)_图_16-4_Queued_Spinlock_等待链(简化版)
...
## 16.12_per-CPU_自旋锁与_qspinlock_实际代码结构

------

### 16.12.1_Linux_自旋锁的两条实现路线
...
#### (2)_struct_raw_spinlock(RT前后语义不同)
...
### 16.12.3_锁的排队结构_struct_mcs_spinlock
...
### 16.12.6_per-CPU_自旋锁(local_lock)
...
### 16.12.7_qspinlock_与_local_lock_对比
...
## 16.13_spin_*_与_raw_spin_*_的区别及_RT_内核行为
...
### 16.13.3_RT_内核对_spinlock_的结构性改造
...
### 16.14.8_〔对比_rwlock_t_vs_rw_semaphore〕

#### (1)_表_16-12-3_两类读写锁特性对照
