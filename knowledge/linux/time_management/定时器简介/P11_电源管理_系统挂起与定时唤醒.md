...
## 11.4_示例_alarmtimer_+_workqueue_的_准时唤醒_+_相位对齐_驱动(可直接编译)
...
## 11.6_示例二_RTC_alarm_路线(内核消费者_+_用户态对照)
...
### 11.6.2_内核消费者驱动_周期性_RTC_唤醒_+_对齐
...
### 11.6.3_用户态对照_最小_RTC_alarm_工具(便于联调)
...
## 11.7_suspend/resume_钩子_补偿与对齐的完整模板
