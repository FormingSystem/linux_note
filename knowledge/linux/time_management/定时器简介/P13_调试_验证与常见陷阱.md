...
### 13.1.2_tracefs_打开关键_tracepoint
...
### 13.1.3_function_graph_复核回调栈(只开自己的函数)
...
## 13.2_用_trace-cmd/KernelShark_做_可视化对齐_检查
...
### 13.4.2_快速区分_BOOTTIME_vs_REALTIME
...
## 13.5_用_ftrace/tracepoints_验证_补跑风暴_是否被抑制
