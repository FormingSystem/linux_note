---
id: knowledge.linux.time_management.定时器简介.p12_常用模式与代码模板
title: "常用模式与代码模板"
kind: mechanism
status: evolving
domains:
...
## 12.3\_中断中推迟到进程上下文(delayed\_work)
...
## 12.4\_带超时的事务执行(completion/timeout\_+\_可选\_hrtimer\_看门狗)
...
## 12.5\_NFC/按键类去抖(IRQ\_to\_delayed\_work\_DTS\_接入)
