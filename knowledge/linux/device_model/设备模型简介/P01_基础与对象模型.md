---
id: knowledge.linux.device_model.设备模型简介.p01_基础与对象模型
title: "基础与对象模型"
kind: mechanism
status: evolving
domains:
...
## 1.1\_Linux\_设备模型系统(Device\_Model\_System)
...
#### (1)\_统一抽象\_struct\_device\_与\_struct\_device\_driver
...
### 1.1.6\_示例\_Platform\_驱动与设备模型关系
...
### 1.2.6\_可视化\_设备模型中的\_kobject\_继承关系
...
#### (2)\_struct\_subsys\_private\_内部组成
...
### 1.3.6\_示例\_Platform\_设备与驱动匹配全过程
...
## 1.4\_device\_与\_device\_driver\_的匹配与绑定过程
