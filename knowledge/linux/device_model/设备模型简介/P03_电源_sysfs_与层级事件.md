...
# 第3章\_电源\_sysfs\_与层级事件

## 3.1\_电源管理(PM)在设备模型中的集成
...
#### (1)\_struct\_dev\_pm\_info(设备电源状态信息)
...
#### (2)\_struct\_dev\_pm\_ops(驱动电源回调)
...
## 3.2\_sysfs\_与\_kobject\_内核对象模型
...
### 3.2.6\_可视化\_kobject\_与\_sysfs\_映射关系
...
## 3.3\_uevent\_与\_udev\_内核事件通知机制
...
### 3.3.6\_可视化\_uevent\_与\_udev\_协作流程
...
## 3.4\_device\_与\_subsystem\_层级管理机制
