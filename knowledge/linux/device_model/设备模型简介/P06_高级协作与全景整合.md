---
id: knowledge.linux.device_model.设备模型简介.p06_高级协作与全景整合
title: "高级协作与全景整合"
kind: mechanism
status: evolving
domains:
...
## 6.1\_设备模型与模块依赖\_modalias\_与\_modprobe\_自动加载机制
...
### 6.1.5\_kobject\_uevent()\_与环境变量添加
...
### 6.1.7\_MODULE\_DEVICE\_TABLE\_宏的作用
...
### 6.2.4\_driver\_unregister()\_与\_bus\_remove\_driver()

#### (1)\_源码节选(drivers/base/driver.c)
...
### 6.2.6\_device\_release\_driver\_internal()\_解绑核心逻辑
...
### 6.2.11\_引用计数与\_kobject\_put()\_关系
...
## 6.3\_多总线协作与复合设备机制(Composite\_/\_MFD\_/\_Component\_框架)
...
### 6.3.2\_MFD\_框架(Multi-Function\_Device)
...
### 6.3.3\_mfd\_add\_devices()\_的内部实现
...
### 6.3.5\_Component\_框架示例\_显示子系统(DRM)
...
### 6.3.6\_Composite\_框架(复合\_USB\_设备)
...
## 6.4\_ACPI/OF\_抽象与\_fwnode\_handle\_框架
...
### 6.4.1\_主题引入\_统一\_ACPI\_与\_Device\_Tree\_的抽象需求
...
### 6.4.3\_struct\_fwnode\_operations
...
### 6.4.5\_fwnode\_handle\_与\_device\_的关系
...
### 6.4.8\_fwnode\_get\_named\_gpiod()\_示例
...
### 6.4.9\_与\_Software\_Node\_的扩展关系
