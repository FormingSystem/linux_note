...
## 6.1_设备模型与模块依赖_modalias_与_modprobe_自动加载机制
...
### 6.1.7_MODULE_DEVICE_TABLE_宏的作用
...
### 6.2.4_driver_unregister()_与_bus_remove_driver()
...
### 6.2.6_device_release_driver_internal()_解绑核心逻辑
...
## 6.3_多总线协作与复合设备机制(Composite_/_MFD_/_Component_框架)
...
### 6.3.2_MFD_框架(Multi-Function_Device)
...
### 6.3.5_Component_框架示例_显示子系统(DRM)
...
## 6.4_ACPI/OF_抽象与_fwnode_handle_框架
...
### 6.4.1_主题引入_统一_ACPI_与_Device_Tree_的抽象需求
...
### 6.4.3_struct_fwnode_operations
...
### 6.4.5_fwnode_handle_与_device_的关系
...
### 6.4.8_fwnode_get_named_gpiod()_示例
