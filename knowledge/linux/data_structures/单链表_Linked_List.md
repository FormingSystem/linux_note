...
### 5.3.2_关于为什么list_head的删除操作后_删除节点的成员值不为NULL
...
#### (1)_A._防止编译器过度优化_(Compiler_Optimization)
...
#### (2)_B._防止读写撕裂_(Load/Store_Tearing)_32_位系统的痛点
...
### 5.6.3_经典案例_INIT_LIST_HEAD_的不对称设计
...
### 5.6.5_总结_32_位_vs_64_位_的防御侧重点对比
...
## 5.7_Linux_Kernel_笔记_内核中的_一次性初始化_(One-Time_Initialization)
...
### 5.7.2_解决方案一_模块生命周期_(Best_Practice)
...
### 5.7.3_解决方案二_显式锁_+_双重检查_(Standard_Pattern)
...
### 5.7.4_解决方案三_无锁原子操作_(Atomic_CAS)
