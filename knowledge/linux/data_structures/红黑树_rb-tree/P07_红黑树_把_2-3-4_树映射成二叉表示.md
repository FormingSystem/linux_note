...
本章的性质和修复前提建立后，以[P33 删除对照](P33_从多路删除到红黑缺口.md#33.1_在两套规则建立以后对照)比较两侄黑时父层吸收、远侄借位与编码准备，再进入 P08/P09 的 Linux 节点结构和调用者责任。后续完整内核插入、删除分别沿 P26/P11 阅读。
...
只有这样，后续 P33 对照以及 P26/P11 内核修复在解释“为什么这里要染色、为什么这里要旋转”时，才不会重新断掉。
...
#### (8)\_解法三\_叔叔为黑\_内侧\_先转外侧\_再旋转\_+\_染色
