...
### 6.6.3\_删除前为什么要先保证\_下行路径不落到\_2-node
...
#### (7)\_具体示例三\_叶子删除后下溢\_兄弟不可借\_只能合并
...
#### (8)\_具体示例四\_内部节点删除\_先转成前驱删除\_再自底向上修复
...
### 6.6.11\_红黑树的删除操作\_以及红黑树和\_2-3-4\_树删除操作的对比
