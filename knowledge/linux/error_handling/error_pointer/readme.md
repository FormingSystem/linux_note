...
# 第1章\_模块\_Linux\_内核错误指针机制(Error\_Pointer\_System)
...
### 1.2.5\_错误指针机制在\_driver\_core\_中的传播路径
...
### 1.2.6\_错误指针机制与\_devres\_自动回滚系统
