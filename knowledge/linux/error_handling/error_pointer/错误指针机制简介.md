...
## 1.3\_设计哲学\_错误即对象(Error\_as\_Object)
...
## 2.2\_错误值体系\_MAX\_ERRNO\_与\_errno\_映射
...
## 3.6\_IS\_ERR\_OR\_NULL()\_综合安全检测
...
## 3.7\_PTR\_ERR\_OR\_ZERO()\_错误码与成功码的统一传播
...
## 4.2\_单返回通道\_思想\_函数的语义统一化

### 4.2.1\_背景问题\_传统返回语义的碎片化
...
# 第5章\_错误指针机制在\_driver\_core\_中的传播路径
...
## 5.3\_driver\_probe\_device()\_的错误传播链
...
## 5.6\_device\_add()\_/\_device\_register()\_中的错误传播

### 5.6.1\_device\_register()
...
## 5.7\_platform\_driver\_框架中的错误传播
...
## 6.4\_错误指针机制在\_devres\_中的意义

### 6.4.1\_devm\_系列接口的设计标准
...
## 6.5\_devm\_系列函数的错误路径

### 6.5.1\_函数示例\_devm\_kzalloc()
...
## 6.7\_devres\_release\_all()\_释放逻辑
...
### 6.7.2\_devres\_release\_all()\_触发时机
...
## 6.10\_devres\_与\_probe()\_的\_事务式\_执行模型
...
### 8.3.1\_实验模块\_测试\_ERR\_PTR\_与\_IS\_ERR
...
## 9.3\_Rust\_for\_Linux\_错误对象的类型化实现
...
## 9.5\_Unified\_Error\_API\_提案(错误接口统一化)
...
## 9.6\_未来趋势\_错误模型的类型化与显式化

### 9.6.1\_从\_宏技巧\_到\_类型系统
...
### 9.6.2\_从\_错误即对象\_到\_错误即值(Error\_as\_Value)
...
## 11.3\_A.2\_ERR\_PTR\_值对照(以\_64\_位内核为例)
...
## 11.5\_A.4\_与用户空间\_errno\_的映射关系
...
# 第12章\_附录B\_ERR\_PTR\_源码索引与注释

------

## 12.1\_B.1\_include/linux/err.h(核心头文件)
...
## 12.3\_B.3\_drivers/base/driver.c(驱动核心)
...
## 12.4\_B.4\_drivers/base/devres.c(资源管理)
...
## 12.5\_B.5\_drivers/gpio/gpiolib.c(子系统示例)
...
## 12.6\_B.6\_include/linux/devm-helpers.h(devres\_协作接口)
