...
## 5.1\_GPIO\_与触发语义\_电平\_边沿\_DTS\_与\_只来一次/一直来\_为何出现
...
### 5.1.3\_中断控制器的视角\_它只管\_怎么触发\_不管\_你为什么要这样触发
...
#### (1)\_interrupts\_=\_<...>\_说的是\_中断控制器那一头要怎么触发
...
#### (2)\_GPIO\_ACTIVE\_LOW\_/\_GPIO\_ACTIVE\_HIGH\_说的是\_逻辑含义
...
### 5.1.5\_为什么驱动里还要再\_irq\_set\_irq\_type()\_一次
...
### 5.1.8\_GPIO\_中断综合案例(同一\_DTS\_三种驱动写法)
...
#### (4)\_示例二\_threaded\_+\_IRQF\_ONESHOT\_+\_printk(复现\_卡死体感)
...
#### (5)\_示例三\_threaded\_+\_trace\_printk\_+\_硬中断时间窗去抖(推荐)
...
### 5.1.9\_综合案例②\_GPIO\_to\_GIC\_多级中断\_+\_清源
