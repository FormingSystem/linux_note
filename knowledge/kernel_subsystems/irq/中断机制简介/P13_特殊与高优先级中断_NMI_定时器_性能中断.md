...
### 13.2.5\_NMI\_与\_irq\_domain/irq\_chip\_的关系
...
### 13.2.6\_示例\_x86\_NMI\_注册(概念性代码)
...
### 13.3.5\_和\_tickless\_/\_NOHZ\_的关系
...
#### (1)\_情况A\_你用的是最普通的\_spin\_lock(&lock);...;\_spin\_unlock(&lock);
...
#### (2)\_情况B\_你用的是\_spin\_lock\_irq()\_/\_spin\_lock\_irqsave()
...
#### (3)\_情况C\_你本来就在\_中断已关\_的上下文里(比如中断上半部里\_又用了普通\_spin\_lock())
...
#### (4)\_延伸一句\_为什么大家常说\_中断里抢不到进程上下文拿着的自旋锁会死
...
### 13.4.6\_示例代码(以\_ARM\_平台\_perf\_驱动为视角的极简示意)
