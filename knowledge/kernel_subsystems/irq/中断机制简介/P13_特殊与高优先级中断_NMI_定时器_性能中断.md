...
### 13.2.5_NMI_与_irq_domain/irq_chip_的关系
...
#### (1)_情况A_你用的是最普通的_spin_lock(&lock);...;_spin_unlock(&lock);
...
#### (2)_情况B_你用的是_spin_lock_irq()_/_spin_lock_irqsave()
...
#### (3)_情况C_你本来就在_中断已关_的上下文里(比如中断上半部里_又用了普通_spin_lock())
...
#### (4)_延伸一句_为什么大家常说_中断里抢不到进程上下文拿着的自旋锁会死
...
### 13.4.6_示例代码(以_ARM_平台_perf_驱动为视角的极简示意)
