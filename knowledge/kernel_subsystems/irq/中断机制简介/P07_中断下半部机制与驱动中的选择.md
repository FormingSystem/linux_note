---
id: knowledge.kernel_subsystems.irq.中断机制简介.p07_中断下半部机制与驱动中的选择
title: "中断下半部机制与驱动中的选择"
kind: subsystem
status: evolving
domains:
  - linux
...
## 7.4\_threaded\_IRQ\_把中断\_变成线程\_的下半部
...
## 7.5\_tasklet\_/\_softirq\_老一代的下半部
...
### 7.6.3\_典型的\_中断\_to\_workqueue\_模式
...
## 7.8\_示例\_把第5章的\_trace\_printk\_去抖版\_再下沉一层
