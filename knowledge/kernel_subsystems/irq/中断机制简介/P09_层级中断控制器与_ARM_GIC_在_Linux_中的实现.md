...
## 9.3\_ARM\_GIC\_在层级结构中的角色(怎么放进去)

### 9.3.1\_GIC\_一定是根域(root\_irq\_domain)
...
## 9.4\_GPIO\_/\_外部中断控制器挂到\_GIC\_的路径还原
...
## 9.5\_层级域中的中断号申请\_映射与传播

（本节重点解释“中断号是在哪一层变成最终 virq 的”“触发类型应该在哪一层定”“devm 是怎么配合的”。）

### 9.5.1\_hwirq\_to\_virq\_的分层转换顺序
...
### 9.6.4\_第三层排查\_看\_/proc/interrupts\_的跳数
