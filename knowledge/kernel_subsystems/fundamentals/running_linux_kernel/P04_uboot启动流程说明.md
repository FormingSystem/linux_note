...
#### (3)_形态三_无_SPL(BootROM_直启_proper)
...
### 4.2.6_SPL_to_U-Boot_proper_接力细节
...
### 4.2.7_SPL_to_Linux(Falcon)_另一条_快车道
...
### 4.2.8_多视角对照表(TPL/SPL/Proper/Falcon)
...
## 4.3_第三部分_U-Boot_proper_阶段_舞台中央的登场
...
#### (2)_board_init_f(common/board_f.c)
...
#### (4)_relocate_code(arch/arm/lib/relocate_64.S)
...
#### (6)_board_init_r(common/board_r.c)
...
### 4.3.5_过渡的视角(U-Boot_proper_to_内核)
...
## 4.4_第四部分_CPU_地址空间与内存管理

### 4.4.1_CPU_的世界观_统一的_总线地址
...
### 4.4.4_U-Boot_proper_阶段_搬家与地址空间规划
...
### 4.4.5_Linux_Kernel_阶段_MMU_与虚拟内存的登场
...
## 4.5_第五部分_Relocation_机制_U-Boot_的搬家艺术
...
## 4.7_第七部分_内存管理延伸_突破_4GB_的围墙

### 4.7.1_问题的起点_32_位_CPU_的_4GB_天花板
