...
### 8.3.7_mx6ull_test_emmc/Kconfig修改
...
### 8.3.9_mx6ull_test_emmc/Makefile修改
...
#### (1)_imx6ull-14x14-evk.dts_复制+重命名
...
#### (4)_向_arch/arm/dts/Makefile_新增设备树文件
...
### 9.4.1_解决_imx/sdma/sdma-imx6q.bin_报错问题

#### (1)_在xxx_defconfig添加配置
...
### 9.5.1_imx6ull-14x14-evk-emmc.dts_复制+重命名
...
### 9.5.2_imx6ull-14x14-evk.dts_复制+重命名
...
### 9.5.3_imx6ull.dtsi_复制+重命名

复制一份 `imx6ull.dtsi`，然后将其重命名为 `imx6ull-test.dtsi`。不做修改

### 9.5.4_imx6ul-14x14-evk.dtsi_复制+重命名
...
### 9.8.2_将配置到imx_v7_test_defconfig
...
### 10.7.1_复制$(cross_compile)/libc/lib
...
### 10.7.3_向$(root_fs)/usr/lib_目录添加库文件
...
### 10.7.4_解决无_rcS_文件的错误与hotplug错误
