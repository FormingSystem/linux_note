...
Write-Host "[practice] Lifecycle modules can also be called independently:"
Write-Host "[practice]   ./install.sh"
Write-Host "[practice]   ./run.sh"
Write-Host "[practice]   ./uninstall.sh --minimal"
