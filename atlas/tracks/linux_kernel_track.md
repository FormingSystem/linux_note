...
5. 沿[kref阅读地图](../../knowledge/linux/object_lifetime/kref/大纲.md#第1章_kref_引用计数机制章节大纲)建立“谁保地址、谁持份额、谁关业务”的模型。先读P01～P05的责任与接口，再读P06～P10的退出、交付、查找、锁和RCU；P11区分私有对象与框架对象，P12用[诊断练习](../../knowledge/linux/object_lifetime/kref/P12_典型错误模式与调试线索.md#12.10.2_最小审查流程)检验推理。随后从[P13工程路线](../../knowledge/linux/object_lifetime/kref/大纲.md#1.14_工程模板)按创建、集合、异步、关闭、分层持有顺序阅读P16～P31，返回P13总表，再沿[P14实验路线](../../knowledge/linux/object_lifetime/kref/大纲.md#1.15_源码阅读实验)进入P32基础观察及后续实验，最后回到P15验收。源码问题从[固定版本索引](../../research/source_reading/kref/navigation/P01_Linux_6.12_kref源码阅读索引.md#1.2_按问题进入已落地证据)定位，不按本地实验提交推断上游行为。
