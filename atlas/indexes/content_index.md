...
| 对象生命周期 | [kref 阅读路线](../../knowledge/linux/object_lifetime/kref/大纲.md#1.2_kref_要解决什么问题)、[引用交付模块](../../knowledge/linux/object_lifetime/kref/P01_kref_要解决什么问题.md#1.16.1_运行一次真实工作交付)、[devres](../../knowledge/linux/object_lifetime/devres) |
