...
- Linux 通用机制
    ...
    - 数据结构
        ...
        - 🟢 [红黑树学习路线](../../knowledge/linux/data_structures/红黑树_rb-tree/大纲.md)
            ...
            - 🔴 **未校正** [P36 红黑删除与缺黑位置传播](../../knowledge/linux/data_structures/红黑树_rb-tree/P36_红黑删除与缺黑位置传播.md)
            ...
            - 🔴 **未校正** [P27 Linux 有序遍历与整树销毁](../../knowledge/linux/data_structures/红黑树_rb-tree/P27_Linux有序遍历与整树销毁.md)
    ...
    - 对象生命周期
        ...
        - 🟢 [kref 引用计数机制](../../knowledge/linux/object_lifetime/kref/大纲.md)
            ...
            - 🔴 **未校正** [P16 对象创建与失败清理模板](../../knowledge/linux/object_lifetime/kref/P16_对象创建与失败清理模板.md)
            - 🔴 **未校正** [P17 拥有型链表工程模板](../../knowledge/linux/object_lifetime/kref/P17_拥有型链表工程模板.md)
            - 🔴 **未校正** [P18 拥有型哈希与IRQ工程模板](../../knowledge/linux/object_lifetime/kref/P18_拥有型哈希与IRQ工程模板.md)
            ...
            - 🔴 **未校正** [P23 分阶段失败与资源回滚模板](../../knowledge/linux/object_lifetime/kref/P23_分阶段失败与资源回滚模板.md)
            - 🔴 **未校正** [P24 删除入口与活动排空工程模板](../../knowledge/linux/object_lifetime/kref/P24_删除入口与活动排空工程模板.md)
            - 🔴 **未校正** [P25 RCU查找与业务关闭工程模板](../../knowledge/linux/object_lifetime/kref/P25_RCU查找与业务关闭工程模板.md)
            ...
            - 🔴 **未校正** [P33 缺失引用与未归还责任实验](../../knowledge/linux/object_lifetime/kref/P33_缺失引用与未归还责任实验.md)
            ...
            - 🔴 **未校正** [P38 字段更新与KCSAN实验](../../knowledge/linux/object_lifetime/kref/P38_字段更新与KCSAN实验.md)
            - 🔴 **未校正** [P39 最后归还与Lockdep实验](../../knowledge/linux/object_lifetime/kref/P39_最后归还与Lockdep实验.md)
    ...
    - 🔴 [Linux 同步和异步机制](../../knowledge/linux/synchronization_and_asynchrony/大纲.md)
        ...
        - 🔴 [同步机制](../../knowledge/linux/synchronization_and_asynchrony/synchronization/大纲.md)
            ...
            - 🔴 [RCU 专题](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/大纲.md)
                ...
                - 🔴 [P04 RCU 分类坐标与内核配置](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P04_RCU_分类坐标与内核配置.md)
                - 🔴 [P05 Tree RCU 公共骨架与完整周期](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P05_Tree_RCU_公共骨架与完整周期.md)
                - 🔴 [P06 Tree RCU 读侧执行模型与配置差异](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P06_Tree_RCU_读侧执行模型与配置差异.md)
                - 🔴 [P07 Tree RCU 初始化、拓扑与执行上下文](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P07_Tree_RCU_初始化_拓扑与执行上下文.md)
                - 🔴 [P08 Tree RCU GP 请求与全局生命周期](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P08_Tree_RCU_GP请求与全局生命周期.md)
                - 🔴 [P09 Tree RCU QS、EQS 与 Context Tracking](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P09_Tree_RCU_QS_EQS与Context_Tracking.md)
                - 🔴 [P10 Tree RCU rcu_node 树与分层汇聚](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P10_Tree_RCU_rcu_node树与分层汇聚.md)
                - 🔴 [P11 Tree RCU rcu_segcblist 回调状态机](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P11_Tree_RCU_rcu_segcblist回调状态机.md)
                - 🔴 [P12 Tree RCU 回调执行、批处理与限流](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P12_Tree_RCU_回调执行_批处理与限流.md)
                - 🔴 [P13 Tree RCU 同步等待与 rcu_barrier](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P13_Tree_RCU_同步等待与rcu_barrier.md)
                - 🔴 [P14 Tree RCU force-QS、迟延与 Stall](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P14_Tree_RCU_force_QS迟延与Stall.md)
                - 🔴 [P15 Tree RCU Expedited GP](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P15_Tree_RCU_Expedited_GP.md)
                - 🔴 [P16 Tree RCU NOCB 回调卸载](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P16_Tree_RCU_NOCB回调卸载.md)
                - 🔴 [P17 Tree RCU CPU 热插拔与回调迁移](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P17_Tree_RCU_CPU热插拔与回调迁移.md)
                - 🔴 [P18 SRCU 私有域与双 index 状态机](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P18_SRCU_私有域与双_index_状态机.md)
                - 🔴 [P19 Tasks RCU 任务轨迹宽限期](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P19_Tasks_RCU_任务轨迹宽限期.md)
                - 🔴 [P20 Tiny RCU 单 CPU 实现](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P20_Tiny_RCU_单CPU实现.md)
                - 🔴 [P21 RCU、kref 与复合对象生命周期](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P21_RCU_kref与复合对象生命周期.md)
                - 🔴 [P22 RCU 驱动与子系统应用模式](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P22_RCU_驱动与子系统应用模式.md)
                - 🔴 [P23 RCU 类型语义、Sparse 与 Lockdep](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P23_RCU_类型语义_Sparse与Lockdep.md)
                - 🔴 [P24 RCU 调试、验证与集成误用](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P24_RCU_调试验证与集成误用.md)
                - 🔴 [P25 RCU 内存序、误用与选择边界](../../knowledge/linux/synchronization_and_asynchrony/synchronization/rcu/P25_RCU_内存序_误用与选择边界.md)
...
- 源码阅读
    - 🔴 **未校正** kref 普通引用
        ...
        - 🔴 **未校正** [条件取得与查找窗口导读](../../research/source_reading/kref/navigation/P03_条件取得与查找窗口导读.md)
        - 🔴 **未校正** [最后归还与锁交接导读](../../research/source_reading/kref/navigation/P04_最后归还与锁交接导读.md)
        - 🔴 **未校正** [定时器重启与退出导读](../../research/source_reading/kref/navigation/P05_定时器重启与退出导读.md)
        - 🔴 **未校正** [timer.h状态观察与旧名包装](../../research/source_reading/kref/source_explanations/include/linux/timer.h.md)
        ...
        - 🔴 **未校正** [kobject身份与类型清理导读](../../research/source_reading/kref/navigation/P07_kobject身份与类型清理导读.md)
        - 🔴 **未校正** [kobject.h身份状态与类型描述](../../research/source_reading/kref/source_explanations/include/linux/kobject.h.md)
        - 🔴 **未校正** [kobject.c初始化撤下与类型清理](../../research/source_reading/kref/source_explanations/lib/kobject.c.md)
        ...
        - 🔴 **未校正** [kref.h引用与回调实现](../../research/source_reading/kref/source_explanations/include/linux/kref.h.md)
        - 🔴 **未校正** [refcount.h引用增减实现](../../research/source_reading/kref/source_explanations/include/linux/refcount.h.md)
    ...
    - 内存顺序
        ...
        - 具体实现讲解
            ...
            - 🔴 [barrier.h SMP屏障与发布取得源码实现](../../research/source_reading/memory_ordering/source_explanations/include/asm-generic/barrier.h.md#1.1_从公共调用找到真正执行的分支)
    - 序列计数器
        - 模块概念导读
    ...
    - RCU
        - 模块概念导读
            ...
            - 🔴 [P02 Linux 6.12 RCU 公共接口与读侧模型模块源码概念导读](../../research/source_reading/rcu/navigation/P02_Linux_6.12_RCU公共接口与读侧模型模块源码概念导读.md)
            - 🔴 [P03 Linux 6.12 Tree RCU GP 全局生命周期模块源码概念导读](../../research/source_reading/rcu/navigation/P03_Linux_6.12_Tree_RCU_GP全局生命周期模块源码概念导读.md)
            - 🔴 [P04 Linux 6.12 Tree RCU 拓扑与 CPU 热插拔模块源码概念导读](../../research/source_reading/rcu/navigation/P04_Linux_6.12_Tree_RCU_拓扑与CPU热插拔模块源码概念导读.md)
            - 🔴 [P05 Linux 6.12 Tree RCU force-QS 与 Stall 模块源码概念导读](../../research/source_reading/rcu/navigation/P05_Linux_6.12_Tree_RCU_force_QS与Stall模块源码概念导读.md)
            - 🔴 [P06 Linux 6.12 Tree RCU Expedited GP 模块源码概念导读](../../research/source_reading/rcu/navigation/P06_Linux_6.12_Tree_RCU_Expedited_GP模块源码概念导读.md)
            - 🔴 [P07 Linux 6.12 Tree RCU 回调与 NOCB 模块源码概念导读](../../research/source_reading/rcu/navigation/P07_Linux_6.12_Tree_RCU_回调与NOCB模块源码概念导读.md)
            - 🔴 [P08 Linux 6.12 Tree RCU 同步等待与 rcu_barrier 模块源码概念导读](../../research/source_reading/rcu/navigation/P08_Linux_6.12_Tree_RCU_同步等待与rcu_barrier模块源码概念导读.md)
            - 🔴 [P09 Linux 6.12 Tree SRCU 模块源码概念导读](../../research/source_reading/rcu/navigation/P09_Linux_6.12_Tree_SRCU模块源码概念导读.md)
            - 🔴 [P10 Linux 6.12 Tasks RCU 模块源码概念导读](../../research/source_reading/rcu/navigation/P10_Linux_6.12_Tasks_RCU模块源码概念导读.md)
            - 🔴 [P11 Linux 6.12 Tiny RCU 模块源码概念导读](../../research/source_reading/rcu/navigation/P11_Linux_6.12_Tiny_RCU模块源码概念导读.md)
            - 🔴 [P12 Linux 6.12 RCU Lockdep 适配模块源码概念导读](../../research/source_reading/rcu/navigation/P12_Linux_6.12_RCU_Lockdep适配模块源码概念导读.md#12.1_模块问题与实现所有权)
        - 具体实现讲解
            - 🔴 [P01 Linux 6.12 RCU 公共接口与检查机制源码详解](../../research/source_reading/rcu/source_explanations/P01_Linux_6.12_RCU_公共接口与检查机制源码详解.md)
            - 🔴 [P02 Linux 6.12 Tree RCU 等待桥、QS 与节点汇聚关键函数源码实现](../../research/source_reading/rcu/source_explanations/P02_Linux_6.12_Tree_RCU_等待桥_QS与节点汇聚关键函数源码实现.md)
            - 🔴 [P03 Linux 6.12 Tree RCU 抢占读者债务关键函数源码实现](../../research/source_reading/rcu/source_explanations/P03_Linux_6.12_Tree_RCU_抢占读者债务关键函数源码实现.md)
