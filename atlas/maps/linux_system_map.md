...
| 生命周期 | 如何确保对象被安全持有和释放 | [kref 引用责任](../../knowledge/linux/object_lifetime/kref/P01_kref_要解决什么问题.md#1.6.1_运行完整的责任交接模型)、[devres](../../knowledge/linux/object_lifetime/devres/devres_API说明.md) |
