...
# 第1章 设备树到设备节点的绑定流程（从 DTB 到 driver probe）
...
# 第2章 设备树 compatible 属性与驱动匹配机制详解
...
### 3.2.2 内核数据结构 `struct alias_prop`
...
## 3.4 自动编号机制与 alias 的缺省行为

### 3.4.1 of_alias_get_id() 的行为规则
...
### 3.5.2 驱动源码 `drivers/demo/alias_demo.c`
