...
## 3.3 irq_chip：控制器能力的统一描述

### 3.3.1 为什么需要 irq_chip
...
## 3.5 irq_desc：一条中断线在运行时的完整状态

### 3.5.1 为什么还需要一层 irq_desc
...
### 3.5.2 驱动注册其实就是“往 desc 里挂 action”
