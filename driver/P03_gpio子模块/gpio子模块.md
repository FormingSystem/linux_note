...
>
> [buildroot 添加libgpiod工具说明参考](../../board/nxp/porting/imx6ull-移植u-boot-2025.04_and_kernel-6.1.md#第11章_buildroot_下载工具): buildroot 下载工具。libgpiod 属于用户工具，不属于内核固定模块，需要手动安装到根文件系统，因此需要采用 buildroot 重新下载搭建 libgpiod 工具。
