...
### 11.2.4 “能唤醒”与 IRQF_NO_SUSPEND 的差别
...
### 11.3.2 active / sleep 两套 pin 配置的作用
...
### 11.3.3 唤醒用的 GPIO 必须在 sleep 状态下仍然保持为“能触发中断的输入”
...
### 11.4.1 runtime PM 与系统 suspend 的区别
...
### 11.5.4 “runtime suspend 正常，system suspend 不正常”
