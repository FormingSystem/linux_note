...
##### 1. 你脑子里的模型：一个 PCIe 设备 → 一个中断引脚 → 能中断
...
### 12.7.2 看 /proc/interrupts：到底分到了几条向量
...
### 12.7.3 用 lspci -vvv 看 Capability
...
### 12.7.7 典型问题 4：/proc/interrupts 名字不好看
