...
### 3.1.2 Linux 中引入 fasync 的动机（历史层面）
...
### 3.3.2 F_SETOWN / F_SETSIG 与 fasync 的耦合
...
### 3.3.3 多个 fd、fork/dup 与 fasync 链表
...
### 3.3.4 close()/release() 与“悬挂 fasync_struct”问题
...
### 3.4.4 fasync 与 select/poll/epoll 的组合使用
