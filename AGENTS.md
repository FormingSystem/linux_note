...
./format.sh all --summary
./format.sh all --apply --summary

# 仅处理 Markdown 标题
./format.sh md --summary
./format.sh md --apply --summary

# 仅处理一个 Markdown 文件
./format.sh md appendix/GNU_environment/buildroot/P05_文件系统构建与定制.md
./format.sh md --apply appendix/GNU_environment/buildroot/P05_文件系统构建与定制.md
```
...
```bash
# 预览或应用全仓链接更新
./format.sh links --summary
./format.sh links --apply --summary

# 只扫描或更新一个 Markdown 文件
./format.sh links --summary path/to/note.md
./format.sh links --apply --summary path/to/note.md
