...
2026.08 是 RCU MarkBook 的首次建刊月份。维护者于 2026-08-30 明确授权对本月版本执行一次覆盖刷新，当前产物已经按收敛后的 P01～P25 权威正文、现行源码导航与实现讲解重新生成；它不再代表刷新前的旧快照。生成时的仓库提交、未提交源文件状态、逐文件哈希和产物哈希以[本期来源与产物台账](releases/2026.08/publication.json)为准。此后普通内容更新仍进入下一月版本，只有维护者再次明确授权时才允许覆盖现有月份。
